...
>(
  (
    ...
    React.useEffect(() => {
      ...
      // eslint-disable-next-line react-hooks/set-state-in-effect -- initialize scroll state before subscribing to embla events
      onSelect(api)
...
>((props, ref) => {
  ...
  if (numberOfSlides > 1) {
    return (
        <div ref={ref} className={`flex justify-center p-2 ${props.className}`}>
